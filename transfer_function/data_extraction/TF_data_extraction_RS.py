...
simualtion_folder = os.path.join('TF_RS_delay')
...
external_input_inh_range = np.arange(0, 20.5, step_freq_inh) #Hz
external_input_exc_range = np.arange(0, 20.5, step_freq_exc) #Hz
